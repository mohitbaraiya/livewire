      ...
      <div class="max-w-lg mx-auto lg:max-w-none">
        <form action="/contact" method="POST" class="grid grid-cols-1 gap-y-6">
          ...
          <div>
            ...
            <input id="email" name="email" value="{{ old('email') }}" type="email" autocomplete="email" class="block w-full shadow-sm py-3 px-4 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" placeholder="Email">
          </div>
          @error('email')
               <p class="text-red-500 mt-1">{{ $message }}</p>
          @enderror
          <div>
            ...
            <input type="text" name="phone" value="{{ old('phone') }}" id="phone" autocomplete="tel" class="block w-full shadow-sm py-3 px-4 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" placeholder="Phone">
          </div>
          @error('phone')
               <p class="text-red-500 mt-1">{{ $message }}</p>
          @enderror
          <div>
            ...
            <textarea id="message" name="message" rows="4" class="@error('message')border border-red-500 @enderror form-input block w-full py-3 px-4 placeholoder-gray-500 transition ease-in-out duration-150" placeholder="Message">{{ old('message') }}</textarea>
          </div>
          @error('message')
               <p class="text-red-500 mt-1">{{ $message }}</p>
          @enderror
